...
fn centrevo(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    // m.add_class::<PyAlphabet>()?; // Removed as it is not defined
...
impl PyQueryBuilder {
    ...
    fn get_generation(&self, sim_id: String, generation: usize) -> PyResult<PyPopulation> {
        ...
        for snap in snapshots {
            let seq1 = centrevo_sim::base::Sequence::from_indices(snap.haplotype1_seq);
            let seq2 = centrevo_sim::base::Sequence::from_indices(snap.haplotype2_seq);
