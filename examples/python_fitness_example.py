...
def example_6_run_simulation_with_selection():
    ...
    print(f"  Selection: GC content (optimum=0.5, concentration=2.0)\n")
...
def example_7_compare_neutral_vs_selection():
    ...
    sim_selection = cv.Simulation(structure, mutation, recombination, fitness_selection, config_selection)
    sim_selection.run()
