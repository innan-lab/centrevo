...
use centrevo::simulation::{SimulationConfig, MutationConfig, RecombinationConfig, FitnessConfig, RepeatStructure};
...
fn main() {
    ...
    let mutation_config = MutationConfig::uniform(Alphabet::dna(), 0.001).unwrap();
