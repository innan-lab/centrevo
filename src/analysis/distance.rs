...
pub fn pairwise_distances(
    ...
    let sequences: Vec<&Sequence> = population
        ...
        .flat_map(|ind| {
            [
                ind.haplotype1().get(chromosome_idx).map(|chr| chr.sequence()),
                ind.haplotype2().get(chromosome_idx).map(|chr| chr.sequence()),
            ]
            .into_iter()
            .flatten()
        })
...
mod tests {
    ...
    fn test_pairwise_distances_both_haplotypes() {
        ...
        let alphabet = Alphabet::dna();
        let mut seq1 = Sequence::with_capacity(5, alphabet.clone());
        let mut seq2 = Sequence::with_capacity(5, alphabet);
    ...
    fn test_distance_matrix_both_haplotypes() {
        ...
        let mut seq3 = Sequence::with_capacity(4, alphabet.clone());
        let mut seq4 = Sequence::with_capacity(4, alphabet);
